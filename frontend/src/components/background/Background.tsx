...
const Gradient = styled.div`
  position: absolute;
  background: linear-gradient(0deg, #0d7693, #002342);
  top: 0;
  left: 0;
  height: 100vh;
  width: 100%;
...
const BackgroundImgTop = styled.svg`
  height: 200px;
  left: 0;
  position: fixed;
  top: 0;
...
const BackgroundImgBottom = styled.svg`
      ...
      <BackgroundImg>
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#9EE6F7" stopOpacity="0"></stop>{" "}
              <stop offset="1" stopColor="#9EE6F7" stopOpacity="0.46"></stop>
            </linearGradient>{" "}
            <linearGradient
              id="paint1_linear"
              x1="342.121"
